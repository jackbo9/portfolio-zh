...
const pages = [
  "index.html",
  "index-en.html",
  "project-ai-zhihui.html",
  "project-ai-zhihui-en.html",
...
const bilingualPairs = [
  ...
  ["project-ai-zhihui.html", "project-ai-zhihui-en.html"],
...
for (const [page, source] of documents) {
  ...
  for (const rawTarget of targets) {
    ...
    const isHomeState = /^(?:index(?:-en)?\.html)$/.test(targetPage) && ["about", "zhihui", "youfeed", "sound", "research", "caffeine"].includes(hash);
